...
var Dialog = (function (_super) {
    ...
    Dialog.prototype.createBitmapByName = function (name) {
    ...
    Dialog.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _a, maskBlack, tip, homeBtn, restartBtn, shareBtn, adBtn, that, nickname;
            return __generator(this, function (_b) {
                ...
                shareBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function () {
                    // platform.share() 
                    _this.removeChild(_this.avator);
                    _this.removeChild(nickname);
                    window.getList();
                }, this);
                adBtn = new Buttons();
                adBtn.init(4, '免费复活');
